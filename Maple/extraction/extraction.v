...
Require MapleLightExec.
Require MapleLightDenotation.
Require MapleAST.
Require MapleInter.
...
Extract Inlined Constant MapleAST.string => "String.t".
Extract Constant MapleAST.location =>
"{ lineno : int;
   filename: string;
   byteno: int;
 }".
...
Separate Extraction
   (*MapleLightExec.step MapleLightExec.initial_state MapleLightExec.final_state*) MapleLightDenotation.exec_program MapleAST.program MapleInter.program
